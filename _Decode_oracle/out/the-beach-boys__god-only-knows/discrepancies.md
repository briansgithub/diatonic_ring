...
## Verse beat 29
- truth: `#iø7(bor)` (a#m7(b5)) | engine: `♯iø⁷(b5)(bor)` (Amaj7)
- engine notes: ["A#3","C#4","E4","E4","G##4"] | truth PCs: [1,4,7,10] | engine PCs: [1,4,9,10]
- piano scrape: ["C#3","D#3","E3","G#3"] | piano PCs: [1,3,4,8]
- json: root=1 applied=0 type=7 inv=0 borrowed=[1,2,4,6,7,9,11]
- failing: romanExact, rootPcMatch, bassPcMatch, pcsExact, pianoExact, pianoPcsExact, pianoValidated, usePiano
...
## Bridge beat 45
- truth: `#iø7(bor)` (d#m7(b5)) | engine: `♯iø⁷(b5)(bor)` (Dmaj7)
- engine notes: ["D#3","A3","C##4","Gb4","A4"] | truth PCs: [0,3,6,9] | engine PCs: [2,3,6,9]
